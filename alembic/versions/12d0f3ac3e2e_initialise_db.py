...
def upgrade() -> None:
    ...
    op.create_table('agencies', # pylint: disable=no-member
    ...
    op.create_table('calendar', # pylint: disable=no-member
    ...
    op.create_table('routes', # pylint: disable=no-member
    sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_table('shapes', # pylint: disable=no-member
    sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_table('stop_times', # pylint: disable=no-member
    ...
    op.create_table('stops', # pylint: disable=no-member
    sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_table('trips', # pylint: disable=no-member
    sa.Column('id', sa.String(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('trips') # pylint: disable=no-member
    op.drop_table('stops') # pylint: disable=no-member
    op.drop_table('stop_times') # pylint: disable=no-member
    op.drop_table('shapes') # pylint: disable=no-member
    op.drop_table('routes') # pylint: disable=no-member
    op.drop_table('locations') # pylint: disable=no-member
    op.drop_table('calendar') # pylint: disable=no-member
    op.drop_table('agencies') # pylint: disable=no-member
    # ### end Alembic commands ###
